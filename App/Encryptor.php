...
class Encryptor{
    ...
    protected static $_cachedTables = [];
    protected static $_encryptTable = [];
    protected static $_decryptTable = [];
    protected $_cipherIv;
    protected $_ivSent;
    protected static $_methodSupported = [
        ...
        'idea-cfb'=> [16, 8],
        'rc2-cfb'=> [16, 8],
        //'rc4'=> [16, 0],      //rc4的iv长度为0，会有问题，暂时去掉
        //'rc4-md5'=> [16, 16], //php的openssl找不到rc4-md5这个算法，暂时去掉
        'seed-cfb'=> [16, 16]
    ];
    //
    ...
    protected function EVPBytesToKey($password, $key_len, $iv_len){
        ...
        $this->bytesToKeyResults[$password] = [$key, $iv];
        return [$key, $iv];
    }
    //
